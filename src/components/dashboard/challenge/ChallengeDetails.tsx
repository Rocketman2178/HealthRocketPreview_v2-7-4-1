...
import { ChevronRight, Target, Trophy, X, Award, CheckCircle2, Calendar, Zap, MessageSquare, Users } from 'lucide-react';
...
export function ChallengeDetails({
  ...
  const [showExampleModal, setShowExampleModal] = useState<'daily' | 'weekly' | null>(null);
  ...
  useEffect(() => {
    if (challenge.challenge_id) {
      if (challenge.challenge_id.includes('hoka') || challenge.challenge_id.includes('running')) {
    ...
    if (isContest && isRegistered && user?.id && challenge.challenge_id) {
      const fetchVerificationCount = async () => {
        ...
        if (!error && data) {
          ...
          setVerificationsRequired(data.verifications_required || challenge.verifications_required || 8);
        }
      };
    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-gray-800 rounded-lg max-w-2xl w-full max-h-[85vh] flex flex-col">
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                {challenge.startDate && (
                  <div className="flex items-center gap-1 text-sm text-gray-400">
                    ...
                    <span>Start Date: {new Date(challenge.startDate).toLocaleDateString()}</span>
                  </div>
                )}
                {challenge.registrationEndDate && (
                  <>
                    ...
                    <div className="flex items-center gap-1 text-sm text-gray-400">
                      <Calendar size={14} className="text-orange-500" />
                      <span>Registration Ends: {new Date(challenge.registrationEndDate).toLocaleDateString()}</span>
                    </div>
                  </>
                )}
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          {isContest && (
            <div>
              <h3 className="text-lg font-medium text-white mb-3">Contest Rewards</h3>
                ...
                <div className="bg-orange-500/10 p-3 rounded-lg">
                  ...
                  <ul className="mt-2 space-y-1 ml-4">
                    <li className="flex items-start gap-2 text-sm text-gray-300">
                      ...
                      <span>8 players: 6 Credits for top player (6X return)</span>
                    </li>
                    <li className="flex items-start gap-2 text-sm text-gray-300">
                      <span className="text-orange-500 mt-1">•</span>
                      <span>20 players: 6 Credits each for top 2 players (6X return)</span>
                    </li>
                    <li className="flex items-start gap-2 text-sm text-gray-300">
                      <span className="text-orange-500 mt-1">•</span>
                      <span>50 players: 6 Credits each for top 5 players (6X return)</span>
                    </li>
                  </ul>
                </div>
          ...
          {isContest && (
            <div>
              <h3 className="text-lg font-medium text-white mb-3">How to Play, How to Win:</h3>
              <div className="bg-gray-700/50 rounded-lg p-4">
                <ul className="space-y-2">
                  {challenge.challenge_id?.includes('hoka') || challenge.challenge_id?.includes('running') ? (
                    // HOKA Running Contest specific instructions
                    <>
                      <li className="flex items-start gap-2 text-gray-300">
                        <span className="text-orange-500 mt-1">•</span>
                        <span>Daily: Post Strava App screenshots of your Run Activity *must including name, date, milage and heart rate (<button 
                          onClick={(e) => {
                            e.stopPropagation();
                            setShowExampleModal('daily'); 
                          }} 
                          className="text-orange-500 hover:underline"
                        >see example here</button>)</span>
                      </li>
                      <li className="flex items-start gap-2 text-gray-300">
                        <span className="text-orange-500 mt-1">•</span>
                        <span>Final Day: Post Strava App screenshot of your Run mileage total for the days in the contest.</span>
                      </li>
                      <li className="flex items-start gap-2 text-gray-300">
                        <span className="text-orange-500 mt-1">•</span>
                        <span>Players must post at least 5 Run Activity screenshots and the final Total Mileage screenshot to complete the contest and be eligible for rewards</span>
                      </li>
                      <li className="flex items-start gap-2 text-gray-300">
                        <span className="text-orange-500 mt-1">•</span>
                        <span>Winners will be determined by players that meet the Contest rules and have the highest Total Mileage.</span>
                      </li>
                    </>
                  ) : challenge.challenge_id?.includes('oura') || challenge.challenge_id?.includes('sleep') ? (
                    // Oura Sleep Week Contest specific instructions
                    <>
                      <li className="flex items-start gap-2 text-gray-300">
                        <span className="text-orange-500 mt-1">•</span>
                        <span>Daily: Post Sleep Score screenshots from the Oura App in the Contest Chat (<button 
                          onClick={(e) => {
                            e.stopPropagation();
                            setShowExampleModal('daily');
                          }} 
                      ...
                      <li className="flex items-start gap-2 text-gray-300">
                        <span className="text-orange-500 mt-1">•</span>
                        <span>Final Day: Post Sleep Score Week screenshot from the Oura App (<button 
                          onClick={(e) => {
                            e.stopPropagation();
                      ...
                      <li className="flex items-start gap-2 text-gray-300">
                        <span className="text-orange-500 mt-1">•</span>
                        <span>Players must post all daily and final week screenshots to complete the contest and be eligible for rewards</span>
                      </li>
                      <li className="flex items-start gap-2 text-gray-300">
                        <span className="text-orange-500 mt-1">•</span>
                        <span>Winners will be determined by players that complete the contest with the highest Sleep Score Week totals.</span>
                      </li>
                    </>
                  ) : (
                    ...
                    <>
                      <li className="flex items-start gap-2 text-gray-300">
                        <span className="text-orange-500 mt-1">•</span>
                        <span>Daily: Post verification screenshots in the Contest Chat</span>
                      </li>
                      <li className="flex items-start gap-2 text-gray-300">
                        <span className="text-orange-500 mt-1">•</span>
                      ...
                      <li className="flex items-start gap-2 text-gray-300">
                        <span className="text-orange-500 mt-1">•</span>
                        <span>Players must complete all required verification posts to be eligible for rewards</span>
                      </li>
                      <li className="flex items-start gap-2 text-gray-300">
                        <span className="text-orange-500 mt-1">•</span>
                        <span>Winners will be determined by players that complete the contest with the highest scores.</span>
                      </li>
                    </>
                  )}
                </ul>
          ...
          {challenge.expertReference && (
            <div>
              <h3 className="text-lg font-medium text-white mb-3">Expert Reference</h3>
              <div className="bg-gray-700/50 rounded-lg p-4">
          ...
          {challenge.expertTips && challenge.expertTips.length > 0 && (
            <div>
              <h3 className="text-lg font-medium text-white mb-3">Expert Tips</h3>
              <div className="bg-gray-700/50 rounded-lg p-4">
                <ul className="space-y-3">
                  {challenge.expertTips.map((tip, index) => (
                    <li key={index} className="flex items-start gap-3">
                      <Award size={18} className="text-orange-500 mt-0.5 shrink-0" />
          ...
          {isContest ? (
            <div>
              <h3 className="text-lg font-medium text-white mb-3">Challenge Details</h3>
              <div className="bg-gray-700/50 rounded-lg p-4 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-white font-medium">{challenge.duration || 7} Days</span>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-white font-medium">+{challenge.fuelPoints || 150} FP</span>
                </div>
              </div>
            </div>
          ) : (
            <div>
              ...
              <div className="bg-gray-700/50 rounded-lg p-4 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-white font-medium">{challenge.duration || 21} Days</span>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-white font-medium">+{challenge.fuelPoints || 50} FP</span>
                </div>
              </div>
            </div>
          )}
        ...
        <div className="p-4 border-t border-gray-700 flex items-center justify-between flex-wrap gap-2">
          <div className="flex items-center gap-2">
            <Zap size={18} className="text-orange-500" />
            <span className="text-orange-500 font-medium">+{challenge.fuelPoints || 50} FP</span>
          ...
          <div className="flex items-center gap-3 flex-wrap">
            {isRegistered && !isContest && !isCompleted && (
              <button
                onClick={() => navigate(`/challenge/${challenge.challenge_id}/daily`, { replace: true, state: { fromChallenge: true } })}
            ...
            <button
              ...
              disabled={
                ...
                (!hasCompletedTier0 && challenge.id !== 'mb0' && !challenge.isPremium && !isContest) ||
            ...
            >
              {isUserRegistered
                ...
                : (!challenge.isPremium && nonPremiumChallengesCount >= maxChallenges)
                  ? 'No Slots Available'
                  : (!hasCompletedTier0 && challenge.id !== 'mb0' && challenge.challenge_id !== 'mb0' && !challenge.isPremium && !isContest)
                  ...
                  : loading
                    ...
                    : (challenge.entryFee && challenge.entryFee > 0 && !hasCredits)
                      ...
                      : (
                        <>
                          {challenge.entryFee && challenge.entryFee > 0 ? 'Register for Contest' : 'Start Challenge'}
