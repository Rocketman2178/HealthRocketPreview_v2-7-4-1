...
export function CustomChallengeCard() {
  ...
  if (hasActiveChallenge && challenge) {
    return (
      <Card>
        <div
          onClick={() => navigate(`/custom-challenge/${challenge.id}`)}
        ...
        >
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-1">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  <span className="text-xs bg-orange-500/10 text-orange-500 px-2 py-0.5 rounded-full">Custom</span>
            ...
            <div className="flex items-center gap-1 text-orange-500">
              <Zap size={16} />
              <span className="font-medium">+{challenge.fp_completion_reward} FP</span>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between">
              <div className="flex items-center gap-1 text-lime-500">
                ...
                <span>
                  {challenge.total_completions}/{challenge.target_completions} Completions
                </span>
              </div>
              <div className="flex items-center gap-1">
                <span className="text-orange-500 font-medium">+{challenge.fp_daily_reward} FP Daily</span>
              </div>
            </div>
            {canCompleteToday && (
  ...
  return (
    <Card>
      <div 
        onClick={() => navigate('/custom-challenge/create')}
      ...
      >
        ...
        <p className="text-sm text-gray-300 mb-4">
          Create your own personalized challenge with actions that fit your lifestyle
        </p>
