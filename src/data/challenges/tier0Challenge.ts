...
export const tier0Challenges: Challenge[] = [{
  ...
  implementationProtocol: {
    week1: 'Complete at least 3 of these 5 actions within 2 hours of waking each day:\n- Mindset: 2-minute gratitude reflection\n- Sleep: Track sleep time or sleep score\n- Exercise: 5-minute stretch\n- Nutrition: Glass of water\n- Biohacking: 5 minutes of morning sunlight exposure',
    week2: 'Continue completing at least 3 daily actions and check them off in the challenge interface',
    week3: 'Maintain your routine and track your progress toward 21 completed days'
  },
  verificationMethods: [
    {
      type: 'daily_actions',
...
},
{
  ...
  duration: 21,
  category: 'Bonus',
  description: 'Create your own personalized 21-completion challenge with actions that fit your lifestyle',
  expertReference: 'Health Rocket Team - Gamifying Health to Increase HealthSpan',
  learningObjectives: [
  ...
  requirements: [
    ...
    {
      description: 'Set your daily minimum (how many actions to complete each day)',
  ...
  implementationProtocol: {
    week1: 'Design your custom actions and complete your daily minimum each day',
